 ...
 contract DogAdoptionRepository {
    ...
    */
    function createDogAdoption(string name, address tokenRegistrationAddress, uint tokenId, uint endBlock) 
        contractIsTokenOwner(tokenRegistrationAddress, tokenId) beforeEnd(endBlock) public {
    ...
    */
    function addDogAdopter(uint dogAdoptionId, address tokenRegistrationAddress, uint tokenId) 
        contractIsTokenOwner(tokenRegistrationAddress, tokenId) isNotOwner(dogAdoptionId) isActive(dogAdoptionId) public payable {
    ...
    */
    function cancelDogAdoption(uint dogAdoptionId) 
        isOwner(dogAdoptionId) isActive(dogAdoptionId) public {
    ...
    * @param dogAdoptionId uint ID of the created dog adoption
    */
    function withdraw(uint dogAdoptionId) isNotOwner(dogAdoptionId) isNotActive(dogAdoptionId) public {
    ...
    */
    function dogAdoptionsCount() view public returns(uint) {
    ...
    */
    function dogAdopterAddressesCount(uint dogAdoptionId) view public returns(uint){
    ...
    */
    function getDogAdopter(uint dogAdoptionId, uint position) view public returns (address from, uint amount, bool winner, bool refunded) {
    ...
    */
    modifier isNotActive(uint dogAdoptionId) {
        require(dogAdoptions[dogAdoptionId].canceled == true || 
    ...
    */
    modifier isActive(uint dogAdoptionId) {
        require(dogAdoptions[dogAdoptionId].canceled == false &&  
